...
public interface TtApi {
    ...
    ResponseEntity<Void> delTime(@Parameter(in = ParameterIn.PATH, description = "Id of Time", required=true, schema=@Schema()) @PathVariable("time_id") String timeId);
    ...
    @RequestMapping(value = "/tt/{time_id}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Time> getTtById(@Parameter(in = ParameterIn.PATH, description = "Id of Time", required=true, schema=@Schema()) @PathVariable("time_id") String timeId);
