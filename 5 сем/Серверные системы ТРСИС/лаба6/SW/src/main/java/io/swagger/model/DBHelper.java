...
public class DBHelper {
    ...
    public static void init() throws IOException, SQLException {
        ...
        try {
            ...
            reader = Resources.getResourceAsReader("data.sql");
    ...
    public static List<Time> getAllTIMETABLEs() throws SQLException {

        List<Time> result = new LinkedList<>();
        while (true) {
            ...
            synchronized (connectionHolder.getConnection()) {
                ...
                try (ResultSet rs = stmt.executeQuery()) {
                    while (rs.next()) {
                        ...
                        fakultet.setType(type);
                        fakultet.setTimeId(id);
