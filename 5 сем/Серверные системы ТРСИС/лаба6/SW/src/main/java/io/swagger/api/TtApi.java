...
public interface TtApi {
    ...
    ResponseEntity<Time> createTime(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema())  @Valid @RequestBody Time body, @AuthenticationPrincipal Principal principal);
