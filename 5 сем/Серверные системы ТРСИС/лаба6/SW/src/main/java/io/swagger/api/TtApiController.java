...
public class TtApiController implements TtApi {
   ...
   // public Iterable<jdbcTime> jtime = new jdbcTimeImpl().findByType(1);
    ...
    public ResponseEntity<Time> createTime(@Parameter(in = ParameterIn.DEFAULT, description = "", required=true, schema=@Schema())  @Valid @RequestBody Time body, @AuthenticationPrincipal Principal principal) {
